package com.tribalfs.stargazers.ui.screens.main.icons.adapter;
...
public class StartgazersAdapter extends RecyclerView.Adapter<StartgazersAdapter.ViewHolder>
    ...
    public StartgazersAdapter(Context context) {
        mContext = context;
    ...
    @NonNull
    @Override
    public StartgazersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.view_icon_listview_item, parent, false);
