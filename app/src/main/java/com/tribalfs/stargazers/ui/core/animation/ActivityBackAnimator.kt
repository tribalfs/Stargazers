package com.tribalfs.stargazers.ui.core.animation
...
class ActivityBackAnimator private constructor() {
    ...
    companion object{
        ...
        fun init(
            ...
            rootView: ViewGroup
        ): ActivityBackAnimator {
            return ActivityBackAnimator().apply {
                this.activity = activity
                this.rootView = rootView
                activity.setWindowTransparent(true)
                gestureInterpolator = MotionUtils.resolveThemeInterpolator(
                    activity,
    ...
    private inner class ActivityRoundedCorner : ViewOutlineProvider() {
        private val maxCornerRadius = activity.resources.getDimensionPixelSize(androidx.appcompat.R.dimen.sesl_rounded_corner_radius)
